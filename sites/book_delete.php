...
<body>
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <table>
            ...
            <tr>
                <td align="center" colspan="2"><?php echo '<img style="height: 400px; width: 400px;" src="images/uploads/'.$detailBook["Image"].'">'; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $detailBook["Description"]; ?></td>
            </tr>
            <tr>
                <td width="20%">Date Publish:</td>
                <td><?php echo date_format($date,"d/m/Y"); ?></td>
            </tr>
            <tr>
                <td width="20%">Place Publish:</td>
